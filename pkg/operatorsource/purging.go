...
func NewPurgingReconciler(logger *log.Entry, datastore datastore.Writer, client client.Client) Reconciler {
	return NewPurgingReconcilerWithInterfaceClient(logger, datastore, interface_client.NewClient(client))
}

// NewPurgingReconcilerWithInterfaceClient returns a purging
...
func NewPurgingReconcilerWithInterfaceClient(logger *log.Entry, datastore datastore.Writer, client interface_client.Client) Reconciler {
